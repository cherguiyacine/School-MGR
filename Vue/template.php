...
<body>
    <!-- component -->
    <div>
        <div class="flex  bg-blue-600 rounded-md shadow">
            <nav class="flex flex-col bg-blue-600 w-64 h-screen px-4 tex-gray-900 border border-blue-600">
                ...
                <div class="mt-10 mb-4">
                    <ul class="ml-4">
                        ...
                        <li
                            ...
                            <a href="showAddArticle">
                                <span class="ml-2">Ajouter Article</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                            ...
                            <a href="showaddPresentationDeLecole">

                                <span class="ml-2">Ajouter Presentation</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                            ...
                            <a href="showAddUser">
                                ...
                                <span class="ml-2">Ajouter Utilisateur</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                        ...
                        <li
                            ...
                            <a href="showAddSeance">
                                <span class="ml-2">Ajouter Séance</span>
                            </a>
                        </li>
                        <li
                            class=" px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                            <span>
                                <svg class="fill-current h-5 w-5 " viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
