                    ...
                    <ul class="ml-4">
                        ...
                        <li
                            ...
                            <a href="showAddArticle">
                                <span class="ml-2">Mes enfants</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                            ...
                            <a href="showaddPresentationDeLecole">
                                ...
                                <span class="ml-2">Emploi du temp</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                            ...
                            <a href="showAddUser">
                                ...
                                <span class="ml-2">Notes et remarque</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
                            ...
                            <a href="showAddRepa">
                                <span class="ml-2"> activités extrascolaires</span>
                            </a>
                        </li>
                        <li
                            class="mb-2 px-4 py-4 text-gray-100 flex flex-row  border-gray-300 hover:text-black   hover:bg-gray-300  hover:font-bold rounded ">
